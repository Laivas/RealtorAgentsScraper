...
public class ForSalePrice {
    ...
    public String toString() {
        ...
        sb.append(ForSalePrice.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("count");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ForSalePrice) == false) {
            return false;
        }
        ForSalePrice rhs = ((ForSalePrice) other);
