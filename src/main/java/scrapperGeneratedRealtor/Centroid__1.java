...
public class Centroid__1 {
    ...
    public String toString() {
        ...
        sb.append(Centroid__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("lon");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Centroid__1) == false) {
            return false;
        }
        Centroid__1 rhs = ((Centroid__1) other);
