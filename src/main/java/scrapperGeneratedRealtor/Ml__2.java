...
public class Ml__2 {
    ...
    @JsonProperty("member")
    public Member__3 getMember() {
        return member;
    }

    @JsonProperty("member")
    public void setMember(Member__3 member) {
        this.member = member;
    }
    ...
    public String toString() {
        ...
        sb.append(Ml__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("member");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ml__2) == false) {
            return false;
        }
        Ml__2 rhs = ((Ml__2) other);
