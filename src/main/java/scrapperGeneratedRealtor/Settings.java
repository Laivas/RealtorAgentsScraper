...
public class Settings {
    ...
    private NewFeaturePopupClosed newFeaturePopupClosed;
    ...
    @JsonProperty("new_feature_popup_closed")
    public NewFeaturePopupClosed getNewFeaturePopupClosed() {
        return newFeaturePopupClosed;
    }

    @JsonProperty("new_feature_popup_closed")
    public void setNewFeaturePopupClosed(NewFeaturePopupClosed newFeaturePopupClosed) {
    ...
    @JsonProperty("profile_wizard")
    public void setProfileWizard(ProfileWizard profileWizard) {
