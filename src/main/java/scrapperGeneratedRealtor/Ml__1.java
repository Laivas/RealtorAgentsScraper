...
public class Ml__1 {
    ...
    @JsonProperty("member")
    public Member__1 getMember() {
        return member;
    }

    @JsonProperty("member")
    public void setMember(Member__1 member) {
        this.member = member;
    }
    ...
    public String toString() {
        ...
        sb.append(Ml__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("member");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ml__1) == false) {
            return false;
        }
        Ml__1 rhs = ((Ml__1) other);
