...
public class Member__5 {
    ...
    public String toString() {
        ...
        sb.append(Member__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Member__5) == false) {
            return false;
        }
        Member__5 rhs = ((Member__5) other);
