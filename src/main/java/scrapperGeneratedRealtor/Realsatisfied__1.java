...
public class Realsatisfied__1 {
    ...
    public String toString() {
        ...
        sb.append(Realsatisfied__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("user");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Realsatisfied__1) == false) {
            return false;
        }
        Realsatisfied__1 rhs = ((Realsatisfied__1) other);
