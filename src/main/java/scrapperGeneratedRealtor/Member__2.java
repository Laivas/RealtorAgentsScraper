...
public class Member__2 {
    ...
    public String toString() {
        ...
        sb.append(Member__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Member__2) == false) {
            return false;
        }
        Member__2 rhs = ((Member__2) other);
