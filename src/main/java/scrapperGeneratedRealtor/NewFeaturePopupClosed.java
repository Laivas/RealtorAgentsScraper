...
public class NewFeaturePopupClosed {
    ...
    public String toString() {
        ...
        sb.append(NewFeaturePopupClosed.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NewFeaturePopupClosed) == false) {
            return false;
        }
        NewFeaturePopupClosed rhs = ((NewFeaturePopupClosed) other);
