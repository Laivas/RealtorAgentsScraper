...
public class County {
    ...
    public String toString() {
        ...
        sb.append(County.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof County) == false) {
            return false;
        }
        County rhs = ((County) other);
