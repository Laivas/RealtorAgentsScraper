...
public class Specialization__1 {
    ...
    public String toString() {
        ...
        sb.append(Specialization__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Specialization__1) == false) {
            return false;
        }
        Specialization__1 rhs = ((Specialization__1) other);
