...
public class Photo__2 {
    ...
    public String toString() {
        ...
        sb.append(Photo__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("href");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Photo__2) == false) {
            return false;
        }
        Photo__2 rhs = ((Photo__2) other);
