...
public class Member__3 {
    ...
    public String toString() {
        ...
        sb.append(Member__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Member__3) == false) {
            return false;
        }
        Member__3 rhs = ((Member__3) other);
