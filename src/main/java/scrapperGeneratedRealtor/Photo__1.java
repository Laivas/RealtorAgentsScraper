...
public class Photo__1 {
    ...
    public String toString() {
        ...
        sb.append(Photo__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("href");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Photo__1) == false) {
            return false;
        }
        Photo__1 rhs = ((Photo__1) other);
