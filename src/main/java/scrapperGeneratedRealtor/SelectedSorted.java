...
public class SelectedSorted {
    ...
    public String toString() {
        ...
        sb.append(SelectedSorted.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SelectedSorted) == false) {
            return false;
        }
        SelectedSorted rhs = ((SelectedSorted) other);
