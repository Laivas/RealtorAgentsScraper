...
public class MlsHistory__1 {

    @JsonProperty("member")
    private Member__5 member;
    ...
    @JsonProperty("member")
    public Member__5 getMember() {
        return member;
    }

    @JsonProperty("member")
    public void setMember(Member__5 member) {
        this.member = member;
    }
    ...
    public String toString() {
        ...
        sb.append(MlsHistory__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("member");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MlsHistory__1) == false) {
            return false;
        }
        MlsHistory__1 rhs = ((MlsHistory__1) other);
