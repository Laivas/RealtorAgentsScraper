...
public class ServedArea__1 {
    ...
    public String toString() {
        ...
        sb.append(ServedArea__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ServedArea__1) == false) {
            return false;
        }
        ServedArea__1 rhs = ((ServedArea__1) other);
