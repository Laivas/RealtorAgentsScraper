...
public class BackgroundPhoto__1 {
    ...
    public String toString() {
        ...
        sb.append(BackgroundPhoto__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("href");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BackgroundPhoto__1) == false) {
            return false;
        }
        BackgroundPhoto__1 rhs = ((BackgroundPhoto__1) other);
