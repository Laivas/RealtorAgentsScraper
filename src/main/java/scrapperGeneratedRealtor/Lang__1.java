...
public class Lang__1 {

    @JsonProperty("srp_content")
    private SrpContent__1 srpContent;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new LinkedHashMap<String, Object>();

    @JsonProperty("srp_content")
    public SrpContent__1 getSrpContent() {
        return srpContent;
    }

    @JsonProperty("srp_content")
    public void setSrpContent(SrpContent__1 srpContent) {
    ...
    public String toString() {
        ...
        sb.append(Lang__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Lang__1) == false) {
            return false;
        }
        Lang__1 rhs = ((Lang__1) other);
