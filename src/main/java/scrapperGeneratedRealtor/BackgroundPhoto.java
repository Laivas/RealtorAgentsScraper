...
public class BackgroundPhoto {
    ...
    public String toString() {
        ...
        sb.append(BackgroundPhoto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("href");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BackgroundPhoto) == false) {
            return false;
        }
        BackgroundPhoto rhs = ((BackgroundPhoto) other);
