...
public class Photo__3 {
    ...
    public String toString() {
        ...
        sb.append(Photo__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("href");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Photo__3) == false) {
            return false;
        }
        Photo__3 rhs = ((Photo__3) other);
