...
public class RecentlySold__1 {
    ...
    public String toString() {
        ...
        sb.append(RecentlySold__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("count");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RecentlySold__1) == false) {
            return false;
        }
        RecentlySold__1 rhs = ((RecentlySold__1) other);
