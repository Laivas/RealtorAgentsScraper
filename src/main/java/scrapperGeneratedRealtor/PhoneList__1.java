...
public class PhoneList__1 {

    @JsonProperty("phone_1")
    private Phone1__1 phone1;
    @JsonProperty("phone_2")
    private Phone2__1 phone2;
    @JsonProperty("phone_3")
    private Phone3__1 phone3;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new LinkedHashMap<String, Object>();

    @JsonProperty("phone_1")
    public Phone1__1 getPhone1() {
        return phone1;
    }

    @JsonProperty("phone_1")
    public void setPhone1(Phone1__1 phone1) {
        this.phone1 = phone1;
    }

    @JsonProperty("phone_2")
    public Phone2__1 getPhone2() {
        return phone2;
    }

    @JsonProperty("phone_2")
    public void setPhone2(Phone2__1 phone2) {
        this.phone2 = phone2;
    }

    @JsonProperty("phone_3")
    public Phone3__1 getPhone3() {
        return phone3;
    }

    @JsonProperty("phone_3")
    public void setPhone3(Phone3__1 phone3) {
        this.phone3 = phone3;
    }
    ...
    public String toString() {
        ...
        sb.append(PhoneList__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("phone1");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PhoneList__1) == false) {
            return false;
        }
        PhoneList__1 rhs = ((PhoneList__1) other);
