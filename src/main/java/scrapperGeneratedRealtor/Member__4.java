...
public class Member__4 {
    ...
    public String toString() {
        ...
        sb.append(Member__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Member__4) == false) {
            return false;
        }
        Member__4 rhs = ((Member__4) other);
