...
public class AgentTeamDetails {
    ...
    public String toString() {
        ...
        sb.append(AgentTeamDetails.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AgentTeamDetails) == false) {
            return false;
        }
        AgentTeamDetails rhs = ((AgentTeamDetails) other);
