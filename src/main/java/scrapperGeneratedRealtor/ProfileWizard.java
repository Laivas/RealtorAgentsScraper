...
public class ProfileWizard {
    ...
    public String toString() {
        ...
        sb.append(ProfileWizard.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProfileWizard) == false) {
            return false;
        }
        ProfileWizard rhs = ((ProfileWizard) other);
