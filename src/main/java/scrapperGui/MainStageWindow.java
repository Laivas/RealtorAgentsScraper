...
import scrapperUtil.ScrappingJob;
...
public class MainStageWindow extends Application {
	...
	private RealtorAgentsMainPane mainPane;
	...
	public void initPanes() {
		...
		mainPane = new RealtorAgentsMainPane();
	...
	public void start(Stage primaryStage) throws Exception {
		...
		primaryStage.setTitle("Realtor Agents Scraper");
	...
	public void loadXml() {
		...
		settingsPane.getSettingsPaneHandler().loadSettingsPaneSelectionFromXml();
