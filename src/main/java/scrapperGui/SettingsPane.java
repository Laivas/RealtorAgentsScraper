...
public class SettingsPane extends BorderPane {
	...
	private RadioButton singleThreadedRadioButton;
	
	private RadioButton multiThreadedButton;
	...
	private String[] requestDelayValues = { "500", "1000", "1500", "2000", "3000", "4000", "5000", "7000", "10000" };
	
	private HBox hBox;
	
	private VBox vBox;
	
	private SettingsPaneHandler settingsPaneHandler;
	...
	public SettingsPane() {
		...
		settingsPaneHandler = new SettingsPaneHandler(this);
	...
	public void setHandler() {
		...
		loadProxyButton.setOnAction(settingsPaneHandler);
		
		saveSettingsButton.setOnAction(settingsPaneHandler);
		
		requestDelayComboBox.setOnAction(settingsPaneHandler);
		
		loadProxyFromCsvButton.setOnAction(settingsPaneHandler);
